<script lang="ts">
	export let type: "home" | "about" | "style" | "education" = "home";
</script>
...
{:else if type === "about"}
	<svg
		...
		viewBox="0 0 479.624 479.624"
		xml:space="preserve"
	>
		<g>
			<path
				id="XMLID_2096_"
				d="M260.836,0c-28,0-54.5,6.3-78.3,17.5c-62.6,29-105.9,92.4-105.9,165.9l0,0v24.5v5.9l-37.3,71.3
